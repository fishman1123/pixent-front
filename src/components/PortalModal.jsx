...
export const PortalModal = ({
  ...
  const closeModal = (skipDelay = false) => {
    ...
    // Skip delay if path is "/user"
    const delay = location.pathname === "/user" ? 0 : skipDelay ? 0 : 800;
  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        {showConfirmButtons && (
          <div className="flex-shrink-0 flex flex-col items-center justify-center p-4 border-t border-black bg-white space-y-2">
            <button
