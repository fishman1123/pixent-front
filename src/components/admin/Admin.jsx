...
export const Admin = () => {
  ...
  const showErrorModal = (message, redirectTo = null) => {
    if (!errorShown) {
      setErrorShown(true);
  ...
  useEffect(() => {
    ...
    if (!token) {
      showErrorModal("로그인이 필요합니다. 로그인 후 이용해주세요.", "/login");
    }
  }, [dispatch]);

  // Reset error shown state when component unmounts
  useEffect(() => {
    return () => {
      setErrorShown(false);
    };
  ...
  return (
    <div className="w-full max-w-full mx-auto p-0 h-screen flex flex-col">
      {/* Custom Admin Header - Fixed at top */}
      <div className="bg-black text-white py-4 fixed top-0 left-0 right-0 z-50">
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
                  ...
                  <div className="flex items-center mt-2 sm:mt-0 space-x-2">
                    ...
                    <div className="flex items-center">
                      <label htmlFor="results-top-page-size" className="mr-2 text-sm font-medium text-gray-900">Page size:</label>
                      <div className="flex">
                        <input
                          id="results-top-page-size"
                          type="number"
                          value={tempSize}
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
                  ...
                  <div className="flex items-center mt-2 sm:mt-0 space-x-2">
                    ...
                    <div className="flex items-center">
                      <label htmlFor="users-top-page-size" className="mr-2 text-sm font-medium text-gray-900">Items per page:</label>
                      <div className="flex">
                        <input
                          id="users-top-page-size"
                          type="number"
                          value={tempUserSize}
