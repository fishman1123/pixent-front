...
import PrimeModal from '../PrimeModal.jsx'; // Import the new PrimeModal
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen w-full text-center px-4">
                        ...
                        {content && content.map((item) => (
                            ...
                            >
                                ...
                                <td className="border px-4 py-2" onClick={(e) => e.stopPropagation()}>
                                    <button
                                        className={`px-3 py-1 rounded transition ${isPasswordSet
            ...
            {selectedItem && (
                ...
                >
                    <div className="max-h-[500px] overflow-y-auto space-y-4 scrollbar-hide">
