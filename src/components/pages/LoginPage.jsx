...
// We'll use the env var for the base URL:
const baseUrl = import.meta.env.VITE_API_BASE_URL;
// e.g. "https://perfume-maker-dev.pixent.co.kr/"
      ...
      <div className="w-full max-w-md min-w-[320px]">
        <div className="space-y-6 p-8">
          <div className="space-y-2 mb-8">
            ...
            <p className="text-xs text-center tracking-widest text-gray-500">
              LOGIN PAGE
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-sm tracking-widest group-hover:text-white">
                  GOOGLE
                </span>
                <svg
