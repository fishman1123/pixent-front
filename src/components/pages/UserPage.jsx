        ...
        <div className="flex-col min-h-screen w-full pt-[10px]">
            <div className="flex flex-col pt-[30px] bg-black text-white px-[28px]">
                <div>
                    ...
                    <p className="text-[22px] font-bold">{authState.nickname}님의 프로필</p>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="w-full">
                        <button className="noanimationbutton flex flex-col items-start p-4 min-w-32 max-w-48 h-auto">
                            ...
                            <span className="text-2xl font-bold text-black">{authState.viewAttempts}회</span>
                        </button>
                    </div>
                    <div className="w-full">
                        <button className="noanimationbutton flex flex-col items-start p-4 min-w-32 max-w-48 h-auto">
                            <span className="text-sm text-gray-700">보유 분석권</span>
                            <span className="text-2xl font-bold text-black">{authState.viewChance}00개</span>
                        </button>
                    </div>
                </div>
