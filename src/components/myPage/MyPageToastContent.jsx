    ...
    return (
        <div className="mx-[24px] w-full h-full">
            ...
            <div className="flex justify-between">
                <div className="text-[22px] font-bold">{selectedReport.perfumeName}</div>
            ...
            <div className="flex gap-4 mt-6">
                <div className="w-full">
                    <button className="noanimationbutton flex flex-col items-center p-4 min-w-32 max-w-48 h-auto">
            <span className="text-sm text-gray-700">
              <img src={barChart} alt="chart" className="w-10 h-10 font-light" />
            </span>
              ...
              상세 보고서 확인하기
                ...
                <div className="w-full">
                    <button
                        className="noanimationbutton flex flex-col items-center p-4 min-w-32 max-w-48 h-auto"
                        disabled={disabled}
                        onClick={() => handleCollectionClick(selectedReport.id)}
                    >
            <span className="text-sm text-gray-700">
              <img src={icon} alt="collection-icon" className="w-10 h-10 font-light" />
            </span>
            ...
            <div className="mt-4">
                ...
                >
                    <span className={`${!bottomButtonDisabled ? "text-black" : "text-[#666666]"} text-[16px] pt-1`}>
                        {bottomButtonText}
                    </span>
